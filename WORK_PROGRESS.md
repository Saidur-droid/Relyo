...
- Normal Connect Vercel reaches the Vercel sign-in page. This browser has no authenticated Relyo connection; project binding and proof execution cannot yet proceed. Secure browser sign-in is the next interactive step.
